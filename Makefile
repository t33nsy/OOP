CC = g++ 
OBJS = ./objs/main.o ./objs/ship.o ./objs/shipmanager.o ./objs/gamefield.o ./objs/game.o
MAIN_FILES = ./main.cc
...
GAMEFIELD_HEADERS = ./headers/ShipManager.h ./headers/Ship.h ./headers/GameField.h
